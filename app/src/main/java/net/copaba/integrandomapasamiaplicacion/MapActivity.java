...
public class MapActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        String placename = parametros.getString("place");
        float latitud = Float.parseFloat(parametros.getString("latitude"));
        float longitud = Float.parseFloat(parametros.getString("longitude"));
